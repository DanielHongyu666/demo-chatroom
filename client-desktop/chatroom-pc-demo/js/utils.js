...
参数：
    ...
    @param {code}        params.code          - 国际化文本对象路径 'components.upgrade.title'  == '升级版本'
    @param {subCode}     params.subCode       - 国际化文本对象路径 'components.upgrade.title'  == '升级版本'
...
*/
    function messagebox(params) {
        var template = `<div class="rong-common rong-dialog" v-if="show">
                            <div class="rong-dialog-inner rong-messagebox">
                                <div class="rong-messagebox-bd rong-message-box-left-bd">
                                    {{message}}
                                </div>
                                <div class="rong-messagebox-ft">
                                    <button @click="close" class="rong-button rong-submit" type="button" v-autofocus>{{submitText}}</button>
                                </div>
                            </div>
                        </div>`;
        var options = {
    ...
    function isAudience() {
        var audienceMark = 'role=audience';
        return location.search.indexOf(audienceMark) !== -1;
    }
