...
;appid需更新
AppId={{A2CCF795-7A51-404B-AFAB-87AA245733D1}
...
[Registry]
Root: HKCR; SubKey: {#Protocal}; ValueData: "RCE Protocol"; ValueType: string; Flags: CreateValueIfDoesntExist UninsDeleteKey;
