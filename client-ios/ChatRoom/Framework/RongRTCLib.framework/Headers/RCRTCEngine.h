...
/*!
 ...
 RongRTCLib version: 4.0.3
 RongRTCLib commit: e8d152e
 RongRTCLib time: 202009181805
 */
...
/*!
 ...
 @remarks 资源管理
 */
- (void)setReconnectEnable:(BOOL)enable API_DEPRECATED("Use config.isEnableAutoReconnect property instead", ios(9.0, 9.0));
