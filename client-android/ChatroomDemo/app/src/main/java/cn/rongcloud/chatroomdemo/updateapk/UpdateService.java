...
public class UpdateService extends Service {
    ...
    private String channelId = "cn.rongcloud.chatroomdemo";
    ...
    private static File getDownloadDir(UpdateService service) {
        ...
        //TODO 改用App内部存储，防止用户不给读写权限导致读写失败问题
...
//        }
    ...
    private void buildNotification() {
        ...
        builder = createNotification(this,channelId, getString(R.string.update_app_model_prepare), getString(R.string.update_app_model_prepare), downloadNotificationFlag);
    ...
    private static Notification.Builder createNotification(Context context,String channelId, String title, String content, int flag) {
    ...
    private static class DownloadApk extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (!dir.exists()) {
                ...
                for (File f : files) {
                    if (!TextUtils.equals(f.getName(),file.getName())){
                        f.delete();
                    }
                }
            }
